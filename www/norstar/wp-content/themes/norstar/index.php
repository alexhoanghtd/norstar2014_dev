			...
			<div id="home-page-wrapper">
				...
				<div class="promo-card  clearfix top-card">
					<div class="promo-picture col-md-6">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/promo/top-card.png">
					</div>
				...
				<div class="clearfix row">
					<div class="col-md-5">
						...
						<div class="promo-card col-xs-12" id="promo-video">
							<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/promo/video.png">
							<div>
								<h1>Video</h1>
					...
					<div class="col-md-7">
						<div class="promo-card col-xs-12" id="event-card">
							...
							<div><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/promo/event.png" class="event-image"></div>
						</div>
					</div>
				</div>
				...
				<div>
					...
					<div class="popular-product promo-card girl als-container" id="pop-girl-product">
						<span class="als-prev"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/left-arrow.png" alt="prev" title="previous" /></span>
						<div class="als-viewport">
						    <ul class="als-wrapper">
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/1.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/2.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/3.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/4.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/5.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/1.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/2.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/3.png" alt="orange" ></li>
						      <li class="als-item"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/girl_toys/4.png" alt="orange" ></li>
						...
						<span class="als-next"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/right-arrow.png" alt="next" title="next" /></span>
					</div>
				...
				<div class="clearfix row" style="padding-top: 30px;">
					<div class="col-md-5" >
						<div class="promo-card social-card" id="game-card">
							...
							<div class="promo-picture"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/promo/game.png"></div>
						</div>
					...
					<div class="col-md-7" >
						<div class="promo-card social-card" id="facebook-card">
							...
							<p>Fusce hendrerit rhoncus sapien,<br /> vitae placerat massa vehicula <br />ut. Morbi sodales consectetur </p>
							<a href="#" class="readmore">Gå til spilsiden</a>
							<div class="promo-picture"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/promo/facebook.png"></div>
						</div>
