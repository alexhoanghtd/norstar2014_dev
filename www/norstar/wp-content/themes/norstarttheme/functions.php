...
define( 'JSDIRECTORY', TEMPPATH. "/js");
define( 'CSSDIRECTORY', TEMPPATH. "/css");

define( 'URLNEWS',"/category/nyheder/");
define( 'URLCONTACT',"/konkakt");
define( 'URLSPIL',"/spil");
define( 'URLKonkurrence', '/konkurrence');
define( 'URLForhandlere', '/forhandlere');
define( 'URLKatalog', '/katalog');
define( 'URLOmnorstar', '/om-norstar');
define( 'URLPresses', '/presses');

define( 'URLInstagram', 'http://instagram.com/norstar');
define( 'URLFacebook', 'http://facebook.com/norstar');
define( 'URLYoutube', 'http://facebook.com/norstar');
